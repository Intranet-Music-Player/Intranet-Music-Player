...
public class MainController extends WebMvcConfigurerAdapter {
 	...
 	public @ResponseBody String addNewUser (@RequestBody UserRequest userRequest){
		if ( userRepository.findByUserlogin(userRequest.getUserlogin()) == null){
			if ( userRepository.findByEmail(userRequest.getEmail()) == null){
				User u = new User(userRequest.getName(),userRequest.getUserlogin(),userRequest.getPassword(), userRequest.getEmail());
	...
	public @ResponseBody String addNewPlaylist(	//@RequestParam String nameSong,
...
//			newPlay.setPlaylistDuration(duration);
	...
	public @ResponseBody String addNewArtist (@RequestParam String bandName,
	...
	public @ResponseBody String addNewAlbum (@RequestParam String nameAlbum,
	...
	public @ResponseBody String valoratePlaylist(	@RequestParam String userlogin, 
			 										@RequestParam String playlistName , 
	...
	public @ResponseBody String addSongPlaylist( 	@RequestParam String playlistName,
